...
import ru.coutvv.cybersport.training.util.TextureLoader;
...
//		GL11.glEnd();
	...
	public void setClick() {
		...
		GLFW.glfwSetCursorPosCallback(window, mouse);
		
		GLFW.glfwSetMouseButtonCallback(window, new GLFWMouseButtonCallbackI() {
			public boolean isRealese = true;
			public Thread temp;
			@Override
			public void invoke(long window, int button, int action, int arg3) {
				if(action == GLFW.GLFW_PRESS) {
					System.out.println("Button: " + button + "\t x: " +mouse.getX() + "\t y: " + mouse.getY() + "arg 3: " + arg3);
					isRealese = false;
